...
rm out/igemm_wrw_gtc_gfx908.hsaco
...
-DIGEMM_CONFIG_FILE="\"/dockerx/MIOpen/igemm_codegen/wrw_gtc_mai/config/igemm_wrw_gtc_gfx908.config\"" -DIGEMM_HSACO="\"igemm_wrw_gtc_gfx908.hsaco\"" \
...
# device compilation
arch=gfx908
/opt/rocm-3.5.0/llvm/bin/clang++ -x assembler -target amdgcn--amdhsa -mcpu=$arch -Iout out/igemm_wrw_gtc_gfx908.s -o out/igemm_wrw_gtc_gfx908.hsaco
