...
/opt/rocm/hip/bin/hipcc  -std=c++17 -x hip --cuda-gpu-arch=$ARCH --cuda-device-only -gline-tables-only  -c -O3 driver/gpu_tensor_reorder/tensor_reorder.cpp -o out/general_tensor_reorder.hsaco || exit 1
