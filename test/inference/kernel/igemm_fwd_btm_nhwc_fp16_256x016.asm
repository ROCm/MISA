...
.set s_hi_diff_batch_m, 43
.set s_wi_diff_batch_m, 44
.set s_in_os_diff_batch_m, 45

.set s_kitr, 1
.set s_wei_offset, 46
.set s_out_stride, s_wei_offset
.set s_vmcnt_out, s_magic_1
.set s_br, 47
...
; short wide igemv
.text
.globl igemm_fwd_btm_nhwc_fp16_256x16x16_r3
.p2align 8

.type igemm_fwd_btm_nhwc_fp16_256x16x16_r3,@function
igemm_fwd_btm_nhwc_fp16_256x16x16_r3:
    ...
    s_lshl_b32 s[s_block_ib], s[s_block_ib], 8          ; 256
    v_mov_b32 v[v_ib], v0
    ...
    s_bfe_u32 s[s_shift_m0], s[s_shift_pack_0], 0x00000008 ; offset:0, width:8
...
;     s_lshr_b32 s[s_tmp], s2, 7
;     v_mov_b32 v[v_tmp+1], s[s_tmp]
;     v_lshl_or_b32 v[v_out_os], v[v_tmp+1], 7+2, v[v_tmp]
;     v_lshlrev_b32 v[v_out_os], 2, v[v_out_os]
; 
;     v_mov_b32 v[v_tmp+0], v0
;     v_mov_b32 v[v_tmp+1], v[v_in_os]
;     v_mov_b32 v[v_tmp+2], v[v_in_flag]
;     v_mov_b32 v[v_tmp+3], 0xffffccee
; 
;     global_store_dwordx4 v[v_out_os:v_out_os+1], v[v_tmp:v_tmp+3], s[s_p_out:s_p_out+1]
; 
;     s_endpgm
    ...
    .mdiv_u32_rem_ss s_wi_diff_batch_m, s_hi_diff_batch_m, s_stride_m, s_magic_1, s_shift_m1, s_wo, s_tmp
    ; ihi = iho * s_stride_h + iy * s_dilation_h - s_pad_h
    ; iwi = iwo * s_stride_w + ix * s_dilation_w - s_pad_w
    s_sub_i32 s[s_tmp+4], s[s_x], 1
    s_sub_i32 s[s_tmp+5], s[s_y], 1
    s_mul_i32 s[s_tmp+4], s[s_dilation_w], s[s_tmp+4]
    s_mul_i32 s[s_tmp+5], s[s_dilation_w], s[s_tmp+5]
    s_mul_i32 s[s_wi_diff_batch_m], s[s_stride_w], s[s_wi_diff_batch_m]
    s_mul_i32 s[s_hi_diff_batch_m], s[s_stride_h], s[s_hi_diff_batch_m]
    s_sub_i32 s[s_wi_diff_batch_m], s[s_wi_diff_batch_m], s[s_tmp+4]
    s_sub_i32 s[s_hi_diff_batch_m], s[s_hi_diff_batch_m], s[s_tmp+5]

    s_mul_i32 s[s_out_stride], s[s_stride_m], s[s_out_stride_wo]

    s_mul_i32 s[s_tmp], s[s_hi_diff_batch_m], s[s_wi]
    s_add_u32 s[s_tmp+1], s[s_wi_diff_batch_m], s[s_tmp]
    s_mul_i32 s[s_in_os_diff_batch_m],  s[s_tmp+1], s[s_in_stride_wi]

    s_lshl_b32 s[s_out_stride], s[s_out_stride], 1
    s_lshl_b32 s[s_out_stride_n], s[s_out_stride_n], 1
    s_lshl_b32 s[s_in_os_diff_batch_m], s[s_in_os_diff_batch_m], 1
    ...
    v_cmpx_le_u32 1, v[v_wei_flag+0]
    ds_write2_b32 v[v_sst_b_os], v[v_gld_b+0], v[v_gld_b+1], offset0:17*0  offset1:17*1
    ds_write2_b32 v[v_sst_b_os], v[v_gld_b+2], v[v_gld_b+3], offset0:17*2  offset1:17*3
    s_mov_b64 exec, -1
    v_cmpx_le_u32 1, v[v_wei_flag+1]
    ds_write2_b32 v[v_sst_b_os], v[v_gld_b+4], v[v_gld_b+5], offset0:17*4  offset1:17*5
    ds_write2_b32 v[v_sst_b_os], v[v_gld_b+6], v[v_gld_b+7], offset0:17*6  offset1:17*7
    s_mov_b64 exec, -1
    v_cmpx_le_u32 1, v[v_wei_flag+2]
    ds_write2_b32 v[v_sst_b_os], v[v_gld_b+8], v[v_gld_b+9], offset0:17*8  offset1:17*9
    ds_write2_b32 v[v_sst_b_os], v[v_gld_b+10], v[v_gld_b+11], offset0:17*10  offset1:17*11
    s_mov_b64 exec, -1
    ...
    s_cbranch_scc0 L_igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_end

L_igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_body:
    ; accumulate im
    ...
    s_cbranch_scc0 igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_acc_yx_x_end_1
    s_mov_b32 s[s_move_slice_k_ix], 0
    v_add_nc_i32 v[v_in_ihi], s[s_dilation_h], v[v_in_ihi]
igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_acc_yx_x_end_1:
    v_cmp_gt_u32 s[s_wi], v[v_in_iwi]
    v_cndmask_b32 v[v_in_flag], 0, 1
    v_cmp_gt_u32 s[s_hi], v[v_in_ihi]
    v_cndmask_b32 v[v_in_flag], 0, v[v_in_flag]
igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_acc_yx_end_1:
    ...
    s_cmp_gt_i32 s[s_kitr], 0
    s_cbranch_scc1 L_igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_body

L_igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_end:
    ; ds_read_b128 v[v_b+16:v_b+19], v[v_sld_b_os], offset:17*4*1 + 0*4
    ; ds_read_b128 v[v_b+20:v_b+23], v[v_sld_b_os], offset:17*4*1 + 4*4
    s_waitcnt vmcnt(0)
    ...
    s_cbranch_scc0 L_igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_end_not_load_next
    ; ihi = iho * s_stride_h + iy * s_dilation_h - s_pad_h
    ; iwi = iwo * s_stride_w + ix * s_dilation_w - s_pad_w

    v_add_nc_i32 v[v_in_ihi], s[s_hi_diff_batch_m], v[v_in_ihi]
    v_add_nc_u32 v[v_in_iwi], s[s_wi_diff_batch_m], v[v_in_iwi]
    ...
    v_add_nc_u32 v[v_in_os], s[s_in_os_diff_batch_m], v[v_in_os]
    v_cmp_gt_u32 s[s_wi], v[v_in_iwi]
...
L_igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_end_not_load_next:
    ...
    s_cbranch_scc1 L_igemm_fwd_btm_nhwc_fp16_256x16x16_r3_end
    ; ds_read_b128 v[v_b+ 0:v_b+ 3], v[v_sld_b_os], offset:17*4*0 + 0*4
    ; ds_read_b128 v[v_b+ 4:v_b+ 7], v[v_sld_b_os], offset:17*4*0 + 4*4
    ...
    ; ds_read_b128 v[v_b+12:v_b+15], v[v_sld_b_os], offset:17*4*0 +12*4
    s_cbranch_scc0 L_igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_end
    s_branch L_igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_body
L_igemm_fwd_btm_nhwc_fp16_256x16x16_r3_end:
    s_endpgm
...
.rodata
.p2align 6
.amdhsa_kernel igemm_fwd_btm_nhwc_fp16_256x16x16_r3
