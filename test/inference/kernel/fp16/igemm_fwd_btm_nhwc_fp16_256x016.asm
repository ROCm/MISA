...
igemm_fwd_btm_nhwc_fp16_256x16x16_r3:
    ...
    s_lshl_b32 s[s_block_ib], s[s_block_ib], 8              ; 256 half
    v_mov_b32 v[v_ib], v0
...
igemm_fwd_btm_nhwc_fp16_256x16x16_r3_fma_acc_yx_x_end_1:
    ...
    .fma_1x8_fp16 v_c+16, v_a + 8, v_b + 0
    ...
    .fma_1x8_fp16 v_c+24, v_a + 8, v_b + 8
    ...
    .fma_1x8_fp16 v_c+16, v_a + 9, v_b +16
    ...
    .fma_1x8_fp16 v_c+24, v_a + 9, v_b +24
    ...
    .fma_1x8_fp16 v_c+16, v_a +10, v_b + 0
    ...
    .fma_1x8_fp16 v_c+24, v_a +10, v_b + 8
    ...
    .fma_1x8_fp16 v_c+16, v_a +11, v_b +16
    ...
    .fma_1x8_fp16 v_c+24, v_a +11, v_b +24
    ...
    .fma_1x8_fp16 v_c+16, v_a +12, v_b + 0
    ...
    .fma_1x8_fp16 v_c+24, v_a +12, v_b + 8
    ...
    .fma_1x8_fp16 v_c+16, v_a +13, v_b +16
    ...
    .fma_1x8_fp16 v_c+24, v_a +13, v_b +24
    ...
    .fma_1x8_fp16 v_c+16, v_a +14, v_b + 0
    ...
    .fma_1x8_fp16 v_c+24, v_a +14, v_b + 8
    ds_read_b128 v[v_b+ 0:v_b+ 3], v[v_sld_b_os], offset:17*4*0 + 0*4
    ds_read_b128 v[v_b+ 4:v_b+ 7], v[v_sld_b_os], offset:17*4*0 + 4*4

    s_waitcnt lgkmcnt(4)
    .fma_1x8_fp16 v_c+ 0, v_a + 7, v_b +16
    .fma_1x8_fp16 v_c+16, v_a +15, v_b +16
    ds_read_b128 v[v_b+ 8:v_b+11], v[v_sld_b_os], offset:17*4*0 + 8*4
    ds_read_b128 v[v_b+12:v_b+15], v[v_sld_b_os], offset:17*4*0 +12*4
    s_waitcnt lgkmcnt(4)
    .fma_1x8_fp16 v_c+ 8, v_a + 7, v_b +24
    .fma_1x8_fp16 v_c+24, v_a +15, v_b +24
