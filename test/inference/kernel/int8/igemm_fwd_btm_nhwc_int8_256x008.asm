...
; short wide igemv
.text
.globl igemm_fwd_btm_nhwc_int8_256x8x16_r1
.p2align 8

.type igemm_fwd_btm_nhwc_int8_256x8x16_r1,@function
igemm_fwd_btm_nhwc_int8_256x8x16_r1:
    ...
    s_cbranch_scc0 L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_end

L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_body:
    ; accumulate im
    ...
    s_cbranch_scc0 igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_acc_yx_x_end_1
    s_mov_b32 s[s_move_slice_k_ix], 0
...
igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_acc_yx_x_end_1:
    ...
    v_add_nc_u32 v[v_sld_b_os], s[s_sld_b_stride], v[v_sld_b_os]            ; accumulate sld_b_os
    s_cmp_gt_i32 s[s_kitr], 0
    s_cbranch_scc0 L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_end_1
    ...
    v_add_nc_u32 v[v_in_os+0], s[s_tmp+1], v[v_in_os+0]
    v_add_nc_u32 v[v_in_os+1], s[s_tmp+1], v[v_in_os+1]
    s_cbranch_scc0 igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_acc_yx_x_end_2
    s_mov_b32 s[s_move_slice_k_ix], 0
    v_add_nc_i32 v[v_in_ihi+0], s[s_dilation_h], v[v_in_ihi+0]
    v_add_nc_i32 v[v_in_ihi+1], s[s_dilation_h], v[v_in_ihi+1]
igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_acc_yx_x_end_2:
    ...
    v_add_nc_u32 v[v_sld_b_os], s[s_sld_b_stride], v[v_sld_b_os]            ; accumulate sld_b_os
    s_cmp_gt_i32 s[s_kitr], 0
    s_cbranch_scc1 L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_body

L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_end:
    s_waitcnt vmcnt(0)
...
L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_end_1:
    s_waitcnt vmcnt(0)
    ...
    s_cbranch_scc0 L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_end_not_load_next
...
L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_end_not_load_next:
    ...
    s_cbranch_scc1 L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_end
    ds_read_b128 v[v_b+ 0:v_b+ 3], v[v_sld_b_os], offset:k_n_dword*4*0 + 0*4
    ds_read_b128 v[v_b+ 4:v_b+ 7], v[v_sld_b_os], offset:k_n_dword*4*0 + 4*4
    ds_read_b128 v[v_b+ 8:v_b+11], v[v_sld_b_os], offset:k_n_dword*4*1 + 0*4
    ds_read_b128 v[v_b+12:v_b+15], v[v_sld_b_os], offset:k_n_dword*4*1 + 4*4
    ...
    s_cbranch_scc0 L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_end
    s_branch L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_fma_body
L_igemm_fwd_btm_nhwc_int8_256x8x16_r1_end:
    s_endpgm
...
.rodata
.p2align 6
.amdhsa_kernel igemm_fwd_btm_nhwc_int8_256x8x16_r1
