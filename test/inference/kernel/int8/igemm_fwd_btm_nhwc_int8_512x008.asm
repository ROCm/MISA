...
; short wide igemv
.text
.globl igemm_fwd_btm_nhwc_int8_512x8x16_r1
.p2align 8

.type igemm_fwd_btm_nhwc_int8_512x8x16_r1,@function
igemm_fwd_btm_nhwc_int8_512x8x16_r1:
    ...
    s_cbranch_scc0 L_igemm_fwd_btm_nhwc_int8_512x8x16_r1_fma_end
...
L_igemm_fwd_btm_nhwc_int8_512x8x16_r1_fma_body:
    ...
    s_cbranch_scc0 igemm_fwd_btm_nhwc_int8_512x8x16_r1_fma_acc_yx_x_end_1
    s_mov_b32 s[s_move_slice_k_ix], 0
...
igemm_fwd_btm_nhwc_int8_512x8x16_r1_fma_acc_yx_x_end_1:
    ...
    .fma_1x8_int8x4 v_c+ 0, v_ax + 0, v_b + 0
    .fma_1x8_int8x4 v_c+ 8, v_ax + 4, v_b + 0
    .fma_1x8_int8x4 v_c+16, v_ax + 8, v_b + 0
    .fma_1x8_int8x4 v_c+24, v_ax +12, v_b + 0

    .fma_1x8_int8x4 v_c+ 0, v_ax + 1, v_b + 8
    .fma_1x8_int8x4 v_c+ 8, v_ax + 5, v_b + 8
    .fma_1x8_int8x4 v_c+16, v_ax + 9, v_b + 8
    .fma_1x8_int8x4 v_c+24, v_ax +13, v_b + 8
    ...
    s_waitcnt lgkmcnt(4)
    .fma_1x8_int8x4 v_c+ 0, v_ax + 2, v_b +16
    .fma_1x8_int8x4 v_c+ 8, v_ax + 6, v_b +16
    .fma_1x8_int8x4 v_c+16, v_ax +10, v_b +16
    .fma_1x8_int8x4 v_c+24, v_ax +14, v_b +16

    .fma_1x8_int8x4 v_c+ 0, v_ax + 3, v_b +24
    .fma_1x8_int8x4 v_c+ 8, v_ax + 7, v_b +24
    .fma_1x8_int8x4 v_c+16, v_ax +11, v_b +24
    .fma_1x8_int8x4 v_c+24, v_ax +15, v_b +24
    ...
    v_add_nc_u32 v[v_sld_b_os], s[s_sld_b_stride], v[v_sld_b_os]            ; accumulate sld_b_os
    s_cmp_gt_i32 s[s_kitr], 0
    s_cbranch_scc0 L_igemm_fwd_btm_nhwc_int8_512x8x16_r1_fma_end_1
    ...
    v_add_nc_u32 v[v_in_os+2], s[s_tmp+1], v[v_in_os+2]
    v_add_nc_u32 v[v_in_os+3], s[s_tmp+1], v[v_in_os+3]
    s_cbranch_scc0 igemm_fwd_btm_nhwc_int8_512x8x16_r1_fma_acc_yx_x_end_2
    s_mov_b32 s[s_move_slice_k_ix], 0
    v_add_nc_i32 v[v_in_ihi+0], s[s_dilation_h], v[v_in_ihi+0]
    v_add_nc_i32 v[v_in_ihi+1], s[s_dilation_h], v[v_in_ihi+1]
    v_add_nc_i32 v[v_in_ihi+2], s[s_dilation_h], v[v_in_ihi+2]
    v_add_nc_i32 v[v_in_ihi+3], s[s_dilation_h], v[v_in_ihi+3]
igemm_fwd_btm_nhwc_int8_512x8x16_r1_fma_acc_yx_x_end_2:
    v_cmp_gt_u32 s[s_wi], v[v_in_iwi+0]
    v_cndmask_b32 v[v_in_flag+0], 0, 1
    v_cmp_gt_u32 s[s_wi], v[v_in_iwi+1]
    v_cndmask_b32 v[v_in_flag+1], 0, 1
    ...
    s_waitcnt vmcnt(4) lgkmcnt(4)
    .fma_1x8_int8x4 v_c+ 0, v_ay + 0, v_b + 0
    .fma_1x8_int8x4 v_c+ 8, v_ay + 4, v_b + 0
    .fma_1x8_int8x4 v_c+16, v_ay + 8, v_b + 0
    .fma_1x8_int8x4 v_c+24, v_ay +12, v_b + 0

    .fma_1x8_int8x4 v_c+ 0, v_ay + 1, v_b + 8
    .fma_1x8_int8x4 v_c+ 8, v_ay + 5, v_b + 8
    .fma_1x8_int8x4 v_c+16, v_ay + 9, v_b + 8
    .fma_1x8_int8x4 v_c+24, v_ay +13, v_b + 8
    ...
    s_waitcnt lgkmcnt(4)
    .fma_1x8_int8x4 v_c+ 0, v_ay + 2, v_b +16
    .fma_1x8_int8x4 v_c+ 8, v_ay + 6, v_b +16
    .fma_1x8_int8x4 v_c+16, v_ay +10, v_b +16
    .fma_1x8_int8x4 v_c+24, v_ay +14, v_b +16

    .fma_1x8_int8x4 v_c+ 0, v_ay + 3, v_b +24
    .fma_1x8_int8x4 v_c+ 8, v_ay + 7, v_b +24
    .fma_1x8_int8x4 v_c+16, v_ay +11, v_b +24
    .fma_1x8_int8x4 v_c+24, v_ay +15, v_b +24
    ...
    v_add_nc_u32 v[v_sld_b_os], s[s_sld_b_stride], v[v_sld_b_os]            ; accumulate sld_b_os
    s_cmp_gt_i32 s[s_kitr], 0
    s_cbranch_scc1 L_igemm_fwd_btm_nhwc_int8_512x8x16_r1_fma_body
...
L_igemm_fwd_btm_nhwc_int8_512x8x16_r1_fma_end_1:
    s_waitcnt vmcnt(0)
    ...
    s_cbranch_scc0 L_igemm_fwd_btm_nhwc_int8_512x8x16_r1_fma_end_not_load_next
...
L_igemm_fwd_btm_nhwc_int8_512x8x16_r1_fma_end_not_load_next:
    ...
    s_cbranch_scc1 L_igemm_fwd_btm_nhwc_int8_512x8x16_r1_end
    ds_read_b128 v[v_b+ 0:v_b+ 3], v[v_sld_b_os], offset:k_n_dword*4*0 + 0*4
    ds_read_b128 v[v_b+ 4:v_b+ 7], v[v_sld_b_os], offset:k_n_dword*4*0 + 4*4
    ds_read_b128 v[v_b+ 8:v_b+11], v[v_sld_b_os], offset:k_n_dword*4*1 + 0*4
    ds_read_b128 v[v_b+12:v_b+15], v[v_sld_b_os], offset:k_n_dword*4*1 + 4*4
...
L_igemm_fwd_btm_nhwc_int8_512x8x16_r1_end:
    s_endpgm
...
.rodata
.p2align 6
.amdhsa_kernel igemm_fwd_btm_nhwc_int8_512x8x16_r1
