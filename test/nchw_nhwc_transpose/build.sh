...
/opt/rocm/hip/bin/hipcc -x hip --cuda-gpu-arch=$ARCH --cuda-device-only -gline-tables-only -save-temps=out/ -c -O3 driver/gpu_batched_transpose/batched_transpose.cpp -o out/batched_transpose.hsaco || exit 1
